...
// load the user class script
import * as userClass from "./user.js";
// import form validation functions with alias
import * as formValidation from "./form.js";
let newUser = new userClass.User("Aiden", "Skinner", "aiden.skinner", "hello@example.ca", "fakepassword");
 ...
 *  */
 $(function () {
    ...
    // get the button
    letbtnHide = $("toggleDivBtn");
    // add a click function
    btnHide.click(function () {
        // get the parent div's p tags
        let paragraph = $(".toggleDiv").find("p");
 ...
 if ($("#btnRegSubmit")) {
    // TO DO: add a click function that calls a callback function
     $("#btnRegSubmit").click(function (e) {
        ...
        // console.log(`UserDetails: ${invalidated_user.displayUser()}`)

        // validate first name
        $("#first-group").children(".errorMessage").html(formValidation.validateFirst(unvalidated_user.firstName));
        // validate last name
        $("#last-group").children(".errorMessage").html(formValidation.validateFirst(unvalidated_user.lastName));
        // validate  username
        $("#username-group").children(".errorMessage").html(formValidation.validateFirst(unvalidated_user.username));
